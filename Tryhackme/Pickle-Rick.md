...
![Gobuster-Output](https://h3rcules.space/u/JkWwMM.png)
...
![login.php](https://h3rcules.space/u/95eVqn.png)
![Credentials](https://h3rcules.space/u/02q4D4.png)
![Login-Successful](https://h3rcules.space/u/uEcCE8.png)
...
![python3-check](https://h3rcules.space/u/SXKDQx.png)
![python3-available](https://h3rcules.space/u/umrGVx.png)
...
![Python-reverse-shell-from-pentestmonkey-website](https://h3rcules.space/u/DZ4noZ.png)

![Python-reverse-shell-command](https://h3rcules.space/u/y8uz5D.png)
![Netcat-Listener](https://h3rcules.space/u/2U8AQ3.png)

- Upon executing the python reverse shell command immediately got the shell with user “www-data” authority from system.

![reverse-shell](https://h3rcules.space/u/g8MECl.png)

- From this folder got first ingredient.

![First-Ingredient](https://h3rcules.space/u/Xa2ZF9.png)

- From this folder read the file “clue.txt” to see contents of the file for remaining ingredients.

![clue.txt](https://h3rcules.space/u/tXLbTM.png)

**#2 This subtask requires you to find second ingredient.**

- Browsed to “/home/rick” folder to get the second ingredient.

![Second-Ingredient](https://h3rcules.space/u/X8RoCj.png)
...
![root-access](https://h3rcules.space/u/9OEfrX.png)

- Browsed to “/root” folder to get the third and last ingredient.

![Third-and-last-ingredient](https://h3rcules.space/u/uWsXmV.png)
